...
if [ ! -d ../zip_falcon_cm12 ]; then 
	mkdir ../zip_falcon_cm12;
fi;

# Copy zImage-dtb
cp -f arch/arm/boot/zImage-dtb ../zip_falcon_cm12/;
ls -l ../zip_falcon_cm12/zImage-dtb;
cd ../zip_falcon_cm12;

# Set zip name
if [ $version ] && [ "$version" != "" ]; then
	zipname="KaminariCM_v"$version"_Falcon";
else
	zipname="KaminariCM_"$builddate"_Falcon";
fi;
...
mv $zipname.zip ../release_falcon_cm12;
