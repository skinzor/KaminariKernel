...
#if defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) || defined(USE_LCD_NOTIFIER) || defined(CONFIG_STATE_NOTIFIER) || defined(CONFIG_STATE_NOTIFIER)
...
#if defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) || defined(USE_LCD_NOTIFIER) || defined(CONFIG_STATE_NOTIFIER) 
