...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER) || defined(CONFIG_STATE_NOTIFIER)
...
#if defined(CONFIG_HAS_EARLYSUSPEND) && !defined(USE_LCD_NOTIFIER) && !defined(CONFIG_STATE_NOTIFIER)
static void __cpuinit powersave_early_suspend(struct early_suspend *handler)
#elif defined(CONFIG_POWERSUSPEND) && !defined(USE_LCD_NOTIFIER) && !defined(CONFIG_STATE_NOTIFIER) || defined(CONFIG_POWERSUSPEND) && (defined(USE_LCD_NOTIFIER) || defined(CONFIG_STATE_NOTIFIER))
static void __cpuinit powersave_suspend(struct power_suspend *handler)
#elif defined(USE_LCD_NOTIFIER) || defined(CONFIG_STATE_NOTIFIER)
...
#if defined(CONFIG_HAS_EARLYSUSPEND) && !defined(USE_LCD_NOTIFIER) && !defined(CONFIG_STATE_NOTIFIER) && !defined(DISABLE_POWER_MANAGEMENT)
static struct early_suspend __refdata _powersave_early_suspend = {
  .suspend = powersave_early_suspend,
  .resume = powersave_late_resume,
  .level = EARLY_SUSPEND_LEVEL_BLANK_SCREEN,
};
#elif defined(CONFIG_POWERSUSPEND) && defined(USE_LCD_NOTIFIER) && !defined (DISABLE_POWER_MANAGEMENT) || defined(CONFIG_POWERSUSPEND) && !defined(USE_LCD_NOTIFIER) && !defined(CONFIG_STATE_NOTIFIER) && !defined (DISABLE_POWER_MANAGEMENT)
...
#elif defined(CONFIG_POWERSUSPEND) && !defined(USE_LCD_NOTIFIER) && !defined(CONFIG_STATE_NOTIFIER) && !defined(DISABLE_POWER_MANAGEMENT) || defined(CONFIG_POWERSUSPEND) && (defined(USE_LCD_NOTIFIER) || \
	defined(CONFIG_STATE_NOTIFIER)) && !defined(DISABLE_POWER_MANAGEMENT)
		if (cpu == 0)
...
#if (defined(CONFIG_STATE_NOTIFIER) && !defined(CONFIG_POWERSUSPEND))
// Callback handler for state notifier
static int zzmoove_state_notifier_callback(struct notifier_block *this,
								unsigned long event, void *data)
{
	switch (event)
	{
		case STATE_NOTIFIER_SUSPEND:
			...
			if (!suspend_flag)
			    zzmoove_suspend();
#ifdef ZZMOOVE_DEBUG
			pr_info("[zzmoove/state_notifier] Device put into suspend mode.\n");
#endif /* ZZMOOVE_DEBUG */
			break;
		...
		case STATE_NOTIFIER_ACTIVE:
			...
			if (suspend_flag)
			    zzmoove_resume();
#ifdef ZZMOOVE_DEBUG
			pr_info("[zzmoove/state_notifier] Device activated.\n");
#endif /* ZZMOOVE_DEBUG */
			break;
...
#endif /* (defined(USE_LCD_NOTIFIER)... */
#if (defined(CONFIG_STATE_NOTIFIER) && !defined(CONFIG_POWERSUSPEND))
	// Register callback handler for state notifier
	zzmoove_state_notif.notifier_call = zzmoove_state_notifier_callback;
	if (state_register_client(&zzmoove_state_notif) != 0) {
		pr_err("%s: Failed to register state nofifier callback\n", __func__);
		return -EFAULT;
	}
#endif /* (defined(CONFIG_STATE_NOTIFIER)... */
